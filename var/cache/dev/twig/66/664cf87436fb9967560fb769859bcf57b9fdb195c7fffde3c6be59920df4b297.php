...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/var/www/html/register_bootstrap_validation/registerUser/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
